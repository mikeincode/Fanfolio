...
export const MOCK_NEWS: MockNewsItem[] = [
  ...
  },
  {
    ...
    summary: "Championship Futures surged as playoff scenarios tightened in the simulated football market, rewarding holders who entered early.",
  ...
  {
    id: "news-10",
    title: "Basketball Star Coin Softens Ahead of Simulated Season Opener",
    summary: "BSC pulled back slightly as the simulated market priced in uncertainty heading into the new season. Long-term holders are watching closely.",
    body: "Basketball Star Coin (BSC) edged lower as the simulated basketball market entered its pre-season phase. Player coin assets tend to price in both current form and future expectations, and uncertainty about the coming season — even simulated — can create hesitation in the market. The Los Angeles FC Stock (LAL) moved in a similar direction. Traders who hold BSC as a long-term position may view this pullback as normal pre-season noise, while shorter-term traders may interpret it as a signal to reassess. This type of pre-event uncertainty is common across real markets.",
    category: "Injury Report",
    timestampLabel: "3d ago",
    sentiment: "bearish",
    relatedAssetIds: ["lebron-coin", "lakers-stock"],
    relatedAssetSymbols: ["BSC", "LAL"],
  ...
  {
    id: "news-11",
    title: "Football QB Star Coin Reaches Simulated Season High",
    summary: "FQBS hit a new high in the simulated market as consistent performance metrics reinforced long-term holder conviction.",
    body: "Football QB Star Coin (FQBS) reached its highest point in the current simulated season after sustained positive performance data. The Kansas City FC Stock (KCC) tracked the move upward as well. FQBS represents a player coin tied to expected on-field excellence — and consistent results reduce the uncertainty that typically creates downward pressure. Long-term holders who added to their positions at lower prices are now seeing the thesis play out in simulated form. This is a case study in patience: holding through normal volatility when fundamentals remain strong.",
    category: "Market Pulse",
    timestampLabel: "4d ago",
    sentiment: "bullish",
    relatedAssetIds: ["mahomes-coin", "chiefs-stock"],
    relatedAssetSymbols: ["FQBS", "KCC"],
    relatedSports: ["Football"],
    relatedAssetTypes: ["Player Coin", "Team Stock"],
